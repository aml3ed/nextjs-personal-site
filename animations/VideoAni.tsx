...
function animate() {
  ...
  timeline
    .set("#clapper", { y: 2, rotate: -20 })
    .set("#top-clapper", { transformOrigin: "bottom left" })
    .to("#top-clapper", { rotate: -20, duration: 1 })
    .to("#clapper", { y: 0, duration: 1 }, "<")
    .to("#top-clapper", { rotate: 0, duration: 0.6, ease: "power3.in" });
}
